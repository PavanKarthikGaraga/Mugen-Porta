...
export async function POST(req) {
    try {
        ...
        // Auto-generated project IDs follow the pattern: ClubID + 2-digit number (e.g., AUTO01, DNC02, CLUB01)
        if ((isY22Student || isY23Student || isY24Student) && selectedProject) {
            // Check if this is an auto-generated project ID (ClubID + 2-digit number)
            // Pattern: one or more uppercase letters followed by exactly 2 digits
            const isAutoGenerated = /^[A-Z]+\d{2}$/.test(selectedProject);
        ...
        try {
            ...
            console.log('Database insertion data:', {
                ...
                isAutoGenerated: selectedProject ? /^[A-Z]+\d{2}$/.test(selectedProject) : false
            });
