    ...
    return (
        <div className="bg-white p-6 md:p-8 max-w-none">
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                ...
                {formData.residenceType === "Hostel" && formData.campus !== "KLH - Bachupally" && formData.campus !== "KLH - Bowrampet" && (
                    <div>
                ...
                {formData.residenceType === "Day Scholar" && formData.campus !== "KLH - Bachupally" && formData.campus !== "KLH - Bowrampet" && (
                    <div>
